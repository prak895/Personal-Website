...
firstPlatform.addEventListener('click',()=>{
    window.open("https://linktr.ee/prak123");
});
secondPlatform.addEventListener('click',()=>{
    window.open("mailto:prakhukmr823@gmail.com");
});
thirdPlatform.addEventListener('click',()=>{
    window.open("https://github.com/prak895");
});
fourthPlatform.addEventListener('click',()=>{
    window.open("https://www.linkedin.com/in/prakhar-kumar-b881421a9/");
});
